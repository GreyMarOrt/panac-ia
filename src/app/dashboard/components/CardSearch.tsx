  ...
  return (
    <div className="w-full border-solid border-2 flex lg:flex-row ph:flex-col lg:min-h-56 lg:max-h-64 lg:mb-5 ph:mb-8 rounded-lg bg-white shadow-md">
      <div className="lg:w-3/5 ph:w-100">
        {photo ? (
          <Image
            src={`https://maps.googleapis.com/maps/api/place/photo?photoreference=${photo}&sensor=false&maxheight=400&maxwidth=400&key=AIzaSyA-oZrhlwEq1NnYp11gT20gVl4IwDBiQ9A`}
            alt="logo"
            width={285}
            height={150}
