          ...
          try {
            // @ts-ignore
              const response = await fetch(
                `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${userLocation.lat()},${userLocation.lng()}&radius=2500&type=${locationToSearch}&key=AIzaSyA-oZrhlwEq1NnYp11gT20gVl4IwDBiQ9A`
              );
